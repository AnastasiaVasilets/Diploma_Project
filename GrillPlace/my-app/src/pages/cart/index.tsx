    ...
    return (
        <div className={styles.cart}>
            <div className={styles.cart__top}>
              <h2 className={styles.content__title}><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className={styles.cart__clear}>
                ...
                <span onClick={onClickRemoveAll}>Clear cart</span>
              </div>
            </div>
            ...
            <div className={styles.cart__bottom}>
              <div className={styles.cart__bottom_details}>
                <span> Amount: <b>{totalCount} pcs</b> </span>
